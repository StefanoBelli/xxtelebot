...
//
			...
			public:
				...
				template<typename T>
				inline ReplyMarkup& operator=(T &&customMarkup) {
					what = std::forward<T>(customMarkup);
					return *this;
				}
...
//
			...
			public:
				...
				template<typename T>
				inline InputMessageContent& operator=(T &&customMarkup) {
					what = std::forward<T>(customMarkup);
					return *this;
				}
...
//
			...
			public:
				...
				template<typename T>
				inline InlineQueryResult& operator=(T &&customMarkup) {
					what = std::forward<T>(customMarkup);
					return *this;
				}
...
//
			...
			public:
				...
				template<typename T>
				inline InputMedia& operator=(T &&customMarkup) {
					what = std::forward<T>(customMarkup);
					return *this;
				}
