 ...
 */
		...
		public:
			...
			api_types::Message forwardMessage(
					const std::string &chatId, const std::string &fromChatId,
					const int &messageId, const bool &disableNotification = false) const;

			api_types::Message sendPhoto(
			...
			api_types::Message sendVideo(
					...
					const std::string &caption = "", const bool &supportsStreaming = false,
					const bool &disableNotification = false, const int &replyToMessageId = -1,
					const types::ReplyMarkup &replyMarkup = "") const;

			api_types::Message sendVoice(
			...
			api_types::Message sendVideoNote(
			...
			api_types::Message sendLocation(
			...
			std::vector<api_types::Message> sendMediaGroup(
			...
			std::vector<api_types::GameHighScore> getGameHighScores(
			...
			api_types::Message editMessageText(
			...
			api_types::Message editMessageReplyMarkup(
					const std::string &inlineMessageId,
			...
			api_types::Message editMessageCaption(
					const std::string &chatId, const std::string &messageId,
					const types::InlineKeyboardMarkup &replyMarkup,
					const std::string &caption) const;
			...
			api_types::Message editMessageLiveLocation(
			...
			std::vector<api_types::ChatMember> getChatAdministrators(
			...
			api_types::UserProfilePhotos getUserProfilePhotos(
					const int &userId, const unsigned &offset = 0,
			...
			bool setWebhook(
					const std::string &url, const int &maxConnections = 40,
			...
			inline Logger const &getLogger() const { return logger; }
