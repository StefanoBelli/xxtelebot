...
bool tgbot::methods::Api::setWebhook(
  ...
  if (!allowedUpdates.size())
    parseJsonObject(http::multiPartUpload(inst, baseApi + "/setWebhook",
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/setWebhook", certificate, url,
                              maxConnections, final),
        value);
  }
...
bool tgbot::methods::Api::setChatPhoto(const std::string &chatId,
  ...
  parseJsonObject(http::multiPartUpload(inst, baseApi + "/setChatPhoto", chatId,
...
api_types::File tgbot::methods::Api::uploadStickerFile(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(http::multiPartUpload(inst, baseApi + "/uploadStickerFile",
                                          userId, pngSticker),
                    value);
  curl_easy_cleanup(inst);
...
bool tgbot::methods::Api::addStickerToSet(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(http::multiPartUpload(inst, baseApi + "/addStickerToSet",
...
bool tgbot::methods::Api::addStickerToSet(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/addStickerToSet", userId, name,
                              emoji, serMaskPosition, pngSticker, ""),
        value);
  curl_easy_cleanup(inst);
...
bool tgbot::methods::Api::createNewStickerSet(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/addStickerToSet", userId, name,
                              emoji, serMaskPosition, pngSticker, title),
        value);
...
api_types::Message tgbot::methods::Api::sendVideo(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/sendVideo", chatId, mimeType,
                              video, duration, width, height, caption,
                              disableNotification, replyToMessageId,
                              replyMarkup.toString(), supportsStreaming),
        value);
...
api_types::Message tgbot::methods::Api::sendDocument(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(http::multiPartUpload(
                        inst, baseApi + "/sendDocument", chatId, mimeType,
                        "document", document, caption, disableNotification,
...
api_types::Message tgbot::methods::Api::sendPhoto(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/sendPhoto", chatId, mimeType,
                              "photo", photo, caption, disableNotification,
                              replyToMessageId, replyMarkup.toString()),
        value);
...
api_types::Message tgbot::methods::Api::sendAudio(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/sendAudio", chatId, mimeType,
                              audio, caption, duration, performer, title,
                              disableNotification, replyToMessageId,
...
api_types::Message tgbot::methods::Api::sendVoice(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(http::multiPartUpload(
                        inst, baseApi + "/sendVoice", chatId, "audio/ogg",
                        "audio", voice, caption, duration, disableNotification,
                        replyToMessageId, replyMarkup.toString()),
                    value);
  curl_easy_cleanup(inst);
...
api_types::Message tgbot::methods::Api::sendSticker(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/sendSticker", chatId, sticker,
                              disableNotification, replyToMessageId,
                              replyMarkup.toString()),
        value);
...
api_types::Message tgbot::methods::Api::sendVideoNote(
  ...
  if (source == types::FileSource::EXTERNAL) {
    ...
    parseJsonObject(
        http::multiPartUpload(inst, baseApi + "/sendVideoNote", chatId,
                              "video/mp4", "video", videoNote, caption,
...
std::vector<api_types::Message> tgbot::methods::Api::sendMediaGroup(
  ...
  parseJsonObject(http::multiPartUpload(inst, baseApi + "/sendMediaGroup",
                                        std::to_string(chatId), media,
                                        disableNotification, replyToMessageId),
                  value);
  curl_easy_cleanup(inst);
...
std::vector<api_types::Message> tgbot::methods::Api::sendMediaGroup(
  ...
  parseJsonObject(
      http::multiPartUpload(inst, baseApi + "/sendMediaGroup", chatId, media,
                            disableNotification, replyToMessageId),
      value);
  curl_easy_cleanup(inst);
