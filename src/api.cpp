...
parseJsonObject(const std::string& serialized, Json::Value& v) {
    ...
    parser->parse(bodyBeginPointer, bodyEndPointer, 
            &v, &reportedErrors);
}
...
api_types::Chat tgbot::methods::Api::getChat(const std::string &chatId) const {
    ...
    parseJsonObject(http::get(inst, baseApi + "/getChat?chat_id=" + chatId), value);
    curl_easy_cleanup(inst);
...
api_types::File tgbot::methods::Api::getFile(const std::string &fileId) const {
    ...
    parseJsonObject(http::get(inst, baseApi + "/getFile?file_id=" + fileId), value);
    curl_easy_cleanup(inst);
...
tgbot::methods::Api::getStickerSet(const std::string &name) const {
    ...
    parseJsonObject(http::get(inst, baseApi + "/getStickerSet?name=" + encode(name)),
            value);
    curl_easy_cleanup(inst);
...
bool tgbot::methods::Api::deleteChatPhoto(const std::string &chatId) const {
    ...
    parseJsonObject(http::get(inst, baseApi + "/deleteChatPhoto?chat_id=" + chatId),
            value);
    curl_easy_cleanup(inst);
...
api_types::Message tgbot::methods::Api::sendDocument(
    ...
    if (source == types::FileSource::EXTERNAL) {
        ...
        parseJsonObject(http::multiPartUpload(inst, baseApi + "/sendDocument", chatId,
...
api_types::Message tgbot::methods::Api::sendPhoto(
    ...
    if (source == types::FileSource::EXTERNAL) {
        ...
        parseJsonObject(http::multiPartUpload(inst, baseApi + "/sendPhoto", chatId,
...
api_types::Message tgbot::methods::Api::sendSticker(
    ...
    if (source == types::FileSource::EXTERNAL) {
        ...
        parseJsonObject(http::multiPartUpload(inst, baseApi + "/sendSticker", chatId,
